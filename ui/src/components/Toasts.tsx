...
/** Fixed daisyUI toast stack (top-end). Mount once, next to the Header. */
    ...
    <div class="toast toast-top toast-end z-50">
      {list.map((t) => (
        <div
          key={t.id}
          role="status"
          class={`alert ${alertClass(t)} text-sm py-2 animate-in fade-in slide-in-from-right duration-300`}
