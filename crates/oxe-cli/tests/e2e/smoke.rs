...
//!
//! Nightly canary for the real upstreams: `oxe engine test <engine>
...
//! relevance.
//!
//! Only runs when `OXE_LIVE=1` (the nightly workflow sets it).
//!
