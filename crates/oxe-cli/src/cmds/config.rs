//! `oxe config <show|path>`: inspect the resolved configuration.
//!
...
use oxe_core::config::{Config, Dirs};

const USAGE: &str = "usage: oxe config <show|path>";
