...
"""Tiny exec-engine fixture for the oxe-engines integration tests.
...
# crates/oxe-engines/tests/fixtures -> repo root -> sdk/python
sys.path.insert(0, str(Path(__file__).resolve().parents[4] / "sdk" / "python"))

from oxe_engine_sdk import Request, Result, run  # noqa: E402
