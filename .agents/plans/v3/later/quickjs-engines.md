...
Seam: `oxe-engines` `Engine` trait; a fourth runtime next to declarative/exec/replay.
...
`engines/<id>.js`, same `EngineError` mapping, same fixture-based `oxe engine test`.
