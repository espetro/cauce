...
Seam: declarative spec loading (`engines/*.yaml` embedded, `$OXE_CONFIG_DIR/engines/`
override) from W1-02.
...
Shape: signed `engines.tar.zst` published from this repo's releases, `oxe engine update`
