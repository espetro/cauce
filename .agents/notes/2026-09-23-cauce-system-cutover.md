...
- Verified: all 8 UI pages + /opensearch.xml 200, /api/search live network results (bing/brave embedded specs), MCP initialize -> "cauce" via :4479 and https://search.localhost/mcp, an OpenAI-compatible AI gateway exposing search-search_web/-exa_search/-cache_status/-cache_invalidate.
